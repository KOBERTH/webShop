  ...
  return (
    <Layout>
      <div className="p-6 flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex flex-col gap-4 lg:w-1/2 justify-center text-custom-white">
          ...
          <div className="flex gap-2">
            ...
            <Button width="w-full" onClick={() => handleAddToCart(product?.id || '', product?.img || '', product?.price || '', product?.name || '')}>
              Add to cart
            </Button>
          </div>
          
          <div className="border border-custom-dark">
            <div className="bg-custom-dark p-2 font-bold uppercase tracking-widest">Details</div>
            <ul className="p-2">
